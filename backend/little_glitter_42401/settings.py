"""
Django settings for little_glitter_42401 project.
...
ROOT_URLCONF = 'little_glitter_42401.urls'
...
WSGI_APPLICATION = 'little_glitter_42401.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_glitter_42401 API",
    "DESCRIPTION": "API documentation for little_glitter_42401 App",
    "VERSION": "v1",
}
